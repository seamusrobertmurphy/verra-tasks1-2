...
Examine structure, scan for errors, and save audit report for later use
in drafting codebook and instruction list ([Appendix I](#appendix1)).
...
``` r
knitr::include_graphics("dataMaid_dataset_tidy.pdf")
```
